...
//        pathState = 0;
        ...
        follower = Constants.createFollower(hardwareMap);
        follower.setStartingPose(new Pose(33.75, 135.5, Math.toRadians(180)));
        paths = new BKPedroAutoBlueClose12.Paths(follower);
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            IntakeThirdSet = follower.pathBuilder()
                    .addPath(new BezierCurve(new Pose(53.000, 90.000), new Pose(61.500, 30.500), new Pose(40.500, 35.500), new Pose(25.00, 36.000)))
                    .setConstantHeadingInterpolation(Math.toRadians(180)).build();
