...
@Autonomous(name = "Blue Auto 15 Gate", group = "Autonomous")
@Configurable
@Config
public class AutoGate15Blue extends OpMode {
    ...
    public int autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 0: // Go to First Shoot
                robot.turret.setTurretTarget(-44);
                if (!follower.isBusy()) {
                    robot.gate.openGate();
    ...
    public static class Paths {
        ...
        public Paths(Follower follower, Robot robot) {
            ...
            ToShoot3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(11.000, 56.500),
                                    new Pose(44.000, 62.500),
                                    new Pose(56.000, 88.000)
                            )
