...
@Autonomous(name = "BK - Red Auto Close 12 Artifact", group = "Autonomous")
@Configurable
@Disabled
public class PedroAutoRedClose12BK extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            IntakeSecondSet = follower.pathBuilder()
                    .addPath(new BezierCurve(new Pose(53.000, 90.000).mirror(), new Pose(52.000, 73.000).mirror(), new Pose(60.000, 59.500).mirror(), new Pose(20.000, 58.000).mirror()))
                    .setConstantHeadingInterpolation(Math.toRadians(0)).build();
            ...
            IntakeThirdSet = follower.pathBuilder()
                    .addPath(new BezierCurve(new Pose(53.000, 90.000).mirror(), new Pose(61.500, 30.500).mirror(), new Pose(44.500, 35.500).mirror(), new Pose(20.00, 36.000).mirror()))
                    .setConstantHeadingInterpolation(Math.toRadians(0)).build();
