...
@Autonomous(name = "AutoFarPathBlue", group = "Autonomous")
@Configurable
public class PedroAutonomousFarWithPathsB extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(288), Math.toRadians(90))
                    .build();
